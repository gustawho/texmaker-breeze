...
#endif
/*
ui.label_4->setIcon(QIcon::fromTheme(QStringLiteral("run-build")));
ui.label_5->setIcon(QIcon::fromTheme(QStringLiteral("go-next")));
*/
  QIcon label_4 = QIcon::fromTheme("run-build");
  QIcon label_5 = QIcon::fromTheme("go-next");
}
