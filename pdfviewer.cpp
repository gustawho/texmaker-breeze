...
connect(LeftPanelToolBar->addAction(QIcon::fromTheme("document-multiple"), tr("Pages")), SIGNAL(triggered()), this, SLOT(ShowListPages()));
...
upAct = new QAction(QIcon::fromTheme("go-up"),  tr("Previous"), this);
upAct->setShortcut(QKeySequence::MoveToPreviousPage);
toolBar->addAction(upAct);

downAct = new QAction(QIcon::fromTheme("go-down"), tr("Next"), this);
...
fitWithAct = new QAction(QIcon::fromTheme("zoom-fit-width"), tr("Fit Width"), this);
toolBar->addAction(fitWithAct);

fitPageAct = new QAction(QIcon::fromTheme("zoom-fit-best"), tr("Fit Page"), this);
...
historyBackAct = new QAction(QIcon::fromTheme("go-previous"),  tr("Previous Position"), this);
...
historyForwardAct = new QAction(QIcon::fromTheme("go-next"),  tr("Next Position"), this);
...
searchAct=new QAction(QIcon::fromTheme("edit-find"), tr("Find"), this);
...
externAct = new QAction(QIcon::fromTheme("acrobat"), tr("External Viewer"), this);
toolBar->addAction(externAct);

checkerAct = new QAction(QIcon::fromTheme("tools-check-spelling"), tr("Check Spelling and Grammar on this page"), this);
