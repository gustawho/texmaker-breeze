...
Act = new QAction(QIcon::fromTheme("go-previous"), tr("Previous Document"), this);
...
Act = new QAction(QIcon::fromTheme("go-next"), tr("Next Document"), this);
...
Act = new QAction(QIcon::fromTheme("document-new"), tr("New"), this);
...
Act = new QAction(QIcon::fromTheme("document-open"), tr("Open"), this);
Act->setShortcut(Qt::CTRL+Qt::Key_O);
connect(Act, SIGNAL(triggered()), this, SLOT(fileOpen()));
fileMenu->addAction(Act);

recentMenu=fileMenu->addMenu(QIcon::fromTheme("document-open-recent"), tr("Open Recent"));
for (int i = 0; i < 10; ++i) 
	{
...
Act = new QAction(QIcon::fromTheme("edit-clear-history"), tr("Clean"), this);
...
Act = new QAction(QIcon::fromTheme("document-save"), tr("Save session"), this);
...
Act = new QAction(QIcon::fromTheme("document-save-all"), tr("Save All"), this);
connect(Act, SIGNAL(triggered()), this, SLOT(fileSaveAll()));
fileMenu->addAction(Act);

Act = new QAction(QIcon::fromTheme("document-save-as"), tr("Save A Copy"), this);
connect(Act, SIGNAL(triggered()), this, SLOT(fileSaveACopy()));
fileMenu->addAction(Act);

Act = new QAction(QIcon::fromTheme("document-save"), tr("Save"), this);
...
Act = new QAction(QIcon::fromTheme("view-refresh"), tr("Reload document from file"), this);
...
Act = new QAction(QIcon::fromTheme("document-print"), tr("Print"), this);
Act->setShortcut(Qt::CTRL+Qt::Key_P);
connect(Act, SIGNAL(triggered()), this, SLOT(filePrint()));
fileMenu->addSeparator();
fileMenu->addAction(Act);

Act = new QAction(QIcon::fromTheme("application-exit"), tr("Exit"), this);
...
Act = new QAction(QIcon::fromTheme("format-indent-more"), tr("Indent"), this);
Act->setData("Indent");
Act->setShortcut(Qt::CTRL+Qt::Key_Greater);
connect(Act, SIGNAL(triggered()), this, SLOT(editIndent()));
editMenu->addAction(Act);

Act = new QAction(QIcon::fromTheme("format-indent-less"), tr("Unindent"), this);
...
Act = new QAction(QIcon::fromTheme("tools-check-spelling"), tr("Check Spelling"), this);
...
Act = new QAction(QIcon::fromTheme("quickopen"), tr("Quick Build"), this);
...
toolMenu->addAction(Act);
toolMenu->addSeparator();
Act = new QAction(QIcon::fromTheme("edit-clear"), tr("Clean"), this);
Act->setData("Clean");
connect(Act, SIGNAL(triggered()), this, SLOT(CleanAll()));
toolMenu->addAction(Act);
toolMenu->addSeparator();
Act = new QAction(QIcon::fromTheme("dialog-scripts"), tr("Open Terminal"), this);
...
toolMenu->addAction(Act);
toolMenu->addSeparator();
Act = new QAction(QIcon::fromTheme("kdenlive-insert-unicode"), tr("Convert to unicode"), this);
Act->setData("Convert to unicode");
connect(Act, SIGNAL(triggered()), this, SLOT(ConvertToUnicode()));
toolMenu->addAction(Act);

Act = new QAction(QIcon::fromTheme("go-previous"), tr("Previous LaTeX Error"), this);
connect(Act, SIGNAL(triggered()), this, SLOT(PreviousError()));
Act = new QAction(QIcon::fromTheme("go-next"), tr("Next LaTeX Error"), this);
...
Act = new QAction(QIcon::fromTheme("format-justify-center"), "\\begin{center} [selection]", this);
Act->setData("\\begin{center}\n/\n\\end{center}/0/1");
connect(Act, SIGNAL(triggered()), this, SLOT(InsertWithSelectionFromAction()));
latex12Menu->addAction(Act);
Act = new QAction(QIcon::fromTheme("format-justify-left"), "\\begin{flushleft} [selection]", this);
Act->setData("\\begin{flushleft}\n/\n\\end{flushleft}/0/1");
connect(Act, SIGNAL(triggered()), this, SLOT(InsertWithSelectionFromAction()));
latex12Menu->addAction(Act);
Act = new QAction(QIcon::fromTheme("format-justify-right"), "\\begin{flushright}  [selection]", this);
Act->setData("\\begin{flushright}\n/\n\\end{flushright}/0/1");
connect(Act, SIGNAL(triggered()), this, SLOT(InsertWithSelectionFromAction()));
latex12Menu->addAction(Act);
...
Act = new QAction(QIcon::fromTheme("format-list-unordered"), "\\begin{itemize}", this);
...
Act = new QAction(QIcon::fromTheme("format-list-ordered"), "\\begin{enumerate}", this);
...
Act = new QAction(QIcon::fromTheme("format-text-italic"), "\\textit - Italics  [selection]", this);
...
connect(Act, SIGNAL(triggered()), this, SLOT(InsertWithSelectionFromAction()));
latex14Menu->addAction(Act);
Act = new QAction(QIcon::fromTheme("format-text-bold"), "\\textbf - Boldface  [selection]", this);
...
scriptMenu=user1Menu->addMenu(QIcon::fromTheme("dialog-scripts"), tr("Run script"));
...
NextDocAct = new QAction(QIcon::fromTheme("go-next"), tr("Next Document"), this);
...
PrevDocAct = new QAction(QIcon::fromTheme("go-previous"), tr("Previous Document"), this);
...
ViewPdfPanelAct = new QAction(QIcon::fromTheme("acrobat"), tr("Pdf Viewer"), this);
...
FullScreenAct = new QAction(QIcon::fromTheme("view-fullscreen"), tr("Full Screen"), this);
...
Act = new QAction(QIcon::fromTheme("configure-toolbars"),  tr("Configure Texmaker"), this);
...
appearanceMenu->addAction(Act);
#if defined(Q_OS_UNIX) && !defined(Q_OS_MAC)
Act = new QAction(QIcon::fromTheme("dialog-text-and-font"), tr("Change Interface Font"), this);
connect(Act, SIGNAL(triggered()), this, SLOT(SetInterfaceFont()));
optionsMenu->addAction(Act);
#endif
optionsMenu->addSeparator();
translationMenu=optionsMenu->addMenu(QIcon::fromTheme("flag"), tr("Interface Language"));
...
Act = new QAction(QIcon::fromTheme("document-save-as"),  tr("Save a copy of the settings file"), this);
...
Act = new QAction(QIcon::fromTheme("help-contents"), tr("LaTeX Reference"), this);
connect(Act, SIGNAL(triggered()), this, SLOT(LatexHelp()));
helpMenu->addAction(Act);
Act = new QAction(QIcon::fromTheme("help-contents"), tr("User Manual"), this);
connect(Act, SIGNAL(triggered()), this, SLOT(UserManualHelp()));
helpMenu->addAction(Act);
helpMenu->addSeparator();
Act = new QAction(QIcon::fromTheme("help-contents"), "TexDoc [selection]", this);
...
if (locale=="fr")
{
Act = new QAction(QIcon::fromTheme("help-contents"), QString::fromUtf8("Documentation LaTeX/Texmaker en ligne"), this);
connect(Act, SIGNAL(triggered()), this, SLOT(Docufrlatex()));
helpMenu->addAction(Act);  
}
else
{
Act = new QAction(QIcon::fromTheme("help-contents"), QString::fromUtf8("LaTeX wikibook"), this);
connect(Act, SIGNAL(triggered()), this, SLOT(Doculatex()));
helpMenu->addAction(Act);  
}  

helpMenu->addSeparator();
Act = new QAction(QIcon::fromTheme("get-hot-new-stuff"),  tr("Check for Update"), this);
...
connect(runToolBar->addAction(QIcon::fromTheme("run-build"), tr("Run")), SIGNAL(triggered()), this, SLOT(doCompile()));
...
connect(runToolBar->addAction(QIcon::fromTheme("run-build"), tr("View")), SIGNAL(triggered()), this, SLOT(doView()));
runToolBar->addWidget(comboView);



Act = new QAction(QIcon::fromTheme("document-preview-archive"), tr("View Log"), this);
connect(Act, SIGNAL(triggered()), this, SLOT(ViewLog()));
...
StopAct = new QAction(QIcon::fromTheme("process-stop"), tr("Stop Process"), this);
...
if (m)
    ...
    comboFiles->setItemIcon(comboFiles->findData(finame,Qt::UserRole,Qt::MatchExactly | Qt::MatchCaseSensitive),QIcon::fromTheme("document-save"));
    if ((check>-1) && (check<OpenedFilesListWidget->count())) OpenedFilesListWidget->item(check)->setIcon(QIcon::fromTheme("document-save"));
...
top->setIcon(0,QIcon::fromTheme("document-multiple"));
